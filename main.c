...
osThreadId Tugas1Handle;
osThreadId Tugas2Handle;
osThreadId Tugas3Handle;
/* USER CODE BEGIN PV */
...
/* USER CODE BEGIN PFP */
void Task3_Init (void const * argumemnt);
/* USER CODE END PFP */
...
int main(void)
{
  ...
  osThreadDef(Tugas1, Pertama, osPriorityNormal, 0, 128);
  Tugas1Handle = osThreadCreate(osThread(Tugas1), NULL);

  /* definition and creation of Tugas2 */
  osThreadDef(Tugas2, Kedua, osPriorityIdle, 0, 128);
  Tugas2Handle = osThreadCreate(osThread(Tugas2), NULL);

  /* definition and creation of Tugas3 */
  osThreadDef(Tugas3, Ketiga, osPriorityIdle, 0, 128);
  Tugas3Handle = osThreadCreate(osThread(Tugas3), NULL);
